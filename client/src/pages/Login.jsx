    ...
    <div className="min-h-[calc(100vh-6rem)]">
      <div className="bg-gradient-to-r from-[#0f766e] to-[#334155] text-white py-6">
        <div className="max-w-6xl mx-auto px-4">
          <h1 className="text-3xl md:text-5xl font-semibold text-center">Login page</h1>
        </div>
      </div>
        ...
        <div className="max-w-md w-full mx-auto md:mx-0">
          <div className="card p-6 md:p-8">
            <div className="flex items-center justify-center gap-6 text-lg">
              <span className="font-semibold border-b-2 border-slate-500">Login</span>
              <Link to="/register" className="opacity-60 hover:opacity-100">SignUp</Link>
            </div>
            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-transparent px-0 pb-1 border-0 border-b border-[#5a6f64] focus:border-[#2f4a3f] outline-none pr-10"
                ...
                <button
                  ...
                  className="absolute right-0 top-1/2 -translate-y-1/2 text-sm opacity-70 hover:opacity-100"
                >{showPass ? '🙈' : '👁️'}</button>
              </div>

              <button className="w-full h-10 rounded-md bg-gradient-to-r from-[#476977] to-[#2d3f48] text-white">Login</button>
